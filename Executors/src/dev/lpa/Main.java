...
public class Main {
    ...
    public static void catchedmain(String[] args) {
        var multiExecutor = Executors.newCachedThreadPool();
        try {
            var redValue = multiExecutor.submit(() -> Main.sum(2, 20, 2, "green"));
            multiExecutor.execute(() -> Main.sum(1, 10, 10, "red"));
            multiExecutor.execute(() -> Main.sum(10, 100, 10, "purple"));
            multiExecutor.execute(() -> Main.sum(2, 20, 2, "yellow"));
            multiExecutor.execute(() -> Main.sum(2, 20, 2, "blue"));
...
//                throw new RuntimeException(e);
//            }
//            System.out.println("Next tasks will be executed");
//            for (var color : new String[]{
//                    "red", "green", "yellow", "cyan", "blue", "purple", "white"}) {
...
//            System.out.println(threadName.toUpperCase());
//            System.out.println(threadColor);
